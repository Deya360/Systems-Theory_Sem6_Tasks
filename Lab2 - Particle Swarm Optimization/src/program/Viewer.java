...
/* Class borrowed from: https://github.com/coobird/simpleimageviewer4j */
 ...
 * <pre>
 ...
 new program.Viewer(img1, img2).show();
 </pre>
 * <p>
 ...
 * <pre>
 ...
 new program.Viewer(images).show();
 </pre>
 *
 * @author coobird
 *
...
public final class Viewer {
    ...
    public void show(boolean play, int delay) {
        if (images.size()==0) return;

        final JFrame f = new JFrame("Particle Swarm Optimization");
        f.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        f.setLayout(new BorderLayout());

        ViewerPanel vp = new ViewerPanel(this.images);
     ...
     * Dispatch Thread (EDT).
     */
    public void run(boolean play, int delay) {
